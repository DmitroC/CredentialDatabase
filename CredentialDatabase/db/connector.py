import logging
import sqlite3
from CredentialDatabase.db.context import PostgresqlCursorContextManager, PostgresqlConnectionContextManager, \
    SQLiteCursorContextManager, SQLiteConnectionContextManager
from CredentialDatabase.exceptions import DBConnectorError
try:
    import psycopg2
...
class DBConnector:
    ...
    def connect_psycopg(cls, host, port, username, password, dbname, minConn=1, maxConn=10):
        ...
        try:
            ...
            logging.getLogger('CredentialDatabase').error('Could not connect to ThreadedConnectionPool: {}'.format(e))
