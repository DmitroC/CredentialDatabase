...
class PasswordDatabase:
    ...
    def __init__(self, breachpath, **dbparams):
        ...
        self.breach = BreachCompilation(folder_path=breachpath, password_db=True, **dbparams)
...
def main():
    ...
    parser.add_argument('--breachpath', type=str, help='path to BreachCompilation Collection')
